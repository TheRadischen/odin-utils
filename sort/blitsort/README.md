...
Cons
---
big binary size 25 kb on optimized
...
slice.sort() becomes slow when you leave L1 cache and terribly degrades once you leave L3 cache and hit main memory, random memory access is sqrt(n)
